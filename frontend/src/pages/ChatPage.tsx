...
const ChatPage: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_top,_rgba(96,165,250,0.28),_transparent_34%),linear-gradient(180deg,_#f8fbff_0%,_#edf4ff_48%,_#e7eefb_100%)] px-3 py-4 sm:px-6 sm:py-8">
      <div className="relative flex h-[calc(100vh-1.5rem)] w-full max-w-[440px] flex-col overflow-hidden rounded-[2.25rem] border border-white/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.88),rgba(241,247,255,0.92))] shadow-[0_24px_80px_rgba(15,23,42,0.18)] sm:h-[min(920px,calc(100vh-4rem))]">
