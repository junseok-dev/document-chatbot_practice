...
class Settings(BaseSettings):
    ...
    default_counseling_prompt: str = Field(
        default=(
            ...
            "[대화 흐름 원칙]\n"
            "1. 처음 묻는 넓은 주제는 핵심 포인트만 간결하게 소개하고, 답변 끝에 "
            "\"어떤 부분이 더 궁금하세요?\" 또는 구체적인 후속 질문 1~2가지를 자연스럽게 제안해 주세요.\n"
            "2. 사용자가 구체적인 부분을 이어서 물어오면 그 부분을 깊이 있게 설명하세요. "
            "이전 대화 맥락과 자연스럽게 연결해 주세요. (예: \"말씀하신 AI 오케스트레이션 과정에서...\") \n"
            "3. 답변이 길어질수록 핵심을 먼저 말하고, 세부 내용은 뒤에 붙이는 구조를 유지하세요.\n"
            "4. 같은 내용을 반복하지 말고, 대화가 진행될수록 더 구체적이고 깊은 내용으로 나아가세요.\n\n"
            "[답변 원칙]\n"
